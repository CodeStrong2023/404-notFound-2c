...
Esta palabra tiene diferentes significados dependiendo dónde
se aplique: 
...
variable en una constante, es decir no se puede modificar su valor,
...
public class TestFinal {
    ...
    public static void main(String[] args) {
        final int miDni = 41083045;
        System.out.println("miDni = " + miDni);
        // miDni = 45656968;  No se puede modificar
        // Persona.CONSTANTE_AQUI = 9;  No se modifica
        System.out.println("Mi atributo constante es = " + Persona.CONSTANTE_AQUI);

        final Persona persona1 = new Persona();
        // persona1 = new Persona(); No se puede asignar una nueva referencia
        persona1.setNombre("Maximiliano Robilotta");
