...
# 1 Listas de palabras que aparecene en las listas
...
interseccion = list(conjunto1 & conjunto2) # Mostramos elementos que coniciden en  ambas listas

print(f"Listas de palabras que aparecene en las listas: {union}")
