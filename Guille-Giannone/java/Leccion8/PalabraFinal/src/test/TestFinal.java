...
Esta palabra tiene diferentes significados dependiendo donde se aplique:
    ...
    metodos: Evita que se modifique la definicion o el comportamiento de un
             metodos desde una subclase (hija).
    clases: Evita que se creen clases hijas
Otra caracteristica es que normalmente, cuando trabajamos con variables se
combina con el modificador de acceso estatico para convertir una variable
...
public class TestFinal {
    public static void main(String[] args) {
        final int miDni = 35999431;
        System.out.println("miDni = " + miDni);
        //miDni = 20356987; No se puede modificar
        //Persona.CONSTANTE_AQUI = 9; //No se modifica
        System.out.println("Mi atributo constante es: "+Persona.CONSTANTE_AQUI);
        
        final Persona persona1 = new Persona();
        //persona1 = new Persona(); NO se puede asignar una nueva referencia
        persona1.setNombre("Guillermo Giannone");
