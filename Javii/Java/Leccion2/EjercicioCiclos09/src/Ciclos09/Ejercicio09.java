/*
Ejercicio 9: Pedir el dia, mes y año de de una fecha e indicar si la fecha es correcta. Suponiendo que todos los meses son de 30
*/
package Ciclos09;
...
public class Ejercicio09 {
	public static void main(String[] args) {
		...
		int anio = Integer.parseInt(JOptionPane.showInputDialog("Digit el  año: "));
		if((dia != 0)&&(dia<=30)){
			if((mes != 0)&&(mes<= 12)){
				if((anio != 0)&&(anio<= 2022)){
