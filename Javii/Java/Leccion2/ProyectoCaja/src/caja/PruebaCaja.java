...
Laformula es: volumen = ancho * alto * profundidad
*/
package caja;
...
public class PruebaCaja {
	public static void main(String[] args) { //Metodo main
		...
		Caja caja2 = new Caja(2,4,6);// Lllamamos al constructor 2 con nuevos argumentos
		//Llamamos con el nuevo objeo al metodo para un nuevo calculo
