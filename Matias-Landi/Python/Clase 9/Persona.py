...
print(persona1.nombre) # Tarea: Hacer el print igual que el objeto 2
...
persona3 = Persona('Rogelio', 'Romero',35789456, 22, 'Teléfono', '02614445557', 'Calle López', 823,
                   'Casa', 18, Altura=1.83, Peso=105, CFavorito= 'Azul', Auto='Citroen', Modelo=2021)
persona3.mostrar_detalle()
#print(persona3._dni) # esto no debe ser utilizado (está encapsulado) en python, esto dice que lo desconocemos
#persona3.__nombre # Está totalmente enapsulado